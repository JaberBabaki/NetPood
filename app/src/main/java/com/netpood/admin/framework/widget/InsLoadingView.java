...
import com.netpood.admin.netpoodapp.BuildConfig;
...
public class InsLoadingView extends ImageView {
    ...
    private static final float strokeWidth = 0.04f;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DEBUG) {
            Log.d(TAG, String.format("onMeasure widthMeasureSpec: %bottombar_tabs -- %bottombar_tabs", widthSpecMode, widthSpecSize));
            Log.d(TAG, String.format("onMeasure heightMeasureSpec: %bottombar_tabs -- %bottombar_tabs", heightSpecMode, heightSpecSize));
        }
        int width;
