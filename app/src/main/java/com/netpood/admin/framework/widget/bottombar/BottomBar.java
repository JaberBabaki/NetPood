...
public class BottomBar extends LinearLayout implements View.OnClickListener, View.OnLongClickListener {
     ...
     * it'bottombar_tabs set, but you'll get all events normally for consecutive tab selection changes.
     *
     * @param listener            a listener for monitoring changes in tab selection.
     * @param shouldFireInitially whether the listener should be fired the first time it'bottombar_tabs set.
     */
    ...
    /**
     * Set a custom typeface for all tab'bottombar_tabs titles.
     *
