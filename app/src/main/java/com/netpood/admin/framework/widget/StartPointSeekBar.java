...
public class StartPointSeekBar extends View {
  ...
  private static final int DEFAULT_RANGE_COLOR = Color.parseColor("#262626");
  private static final int DEFAULT_BACKGROUND_COLOR = Color.parseColor("#C7C7C7");
  ...
  public StartPointSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    if (thumbImageDrawable == null) {
      thumbImageDrawable = getResources().getDrawable(R.drawable.seek_thumb_normals);
    }
    ...
    if (thumbImagePressedDrawable == null) {
      thumbImagePressedDrawable = getResources().getDrawable(R.drawable.seek_thumb_presseds);
    }
    ...
    thumbHalfWidth = 0.3f * thumbWidth;
    thumbHalfHeight = 0.3f * thumbImage.getHeight();
  ...
  /**
   * Tries to claim the user'bottombar_tabs drag motion, and requests disallowing any
  ...
  private void drawThumb(float screenCoord, boolean pressed, Canvas canvas) {
    canvas.drawBitmap(pressed ? thumbPressedImage : thumbImage, screenCoord
        - thumbHalfWidth,
      (float) ((0.31f* getHeight()) - thumbHalfHeight), paint);
  }
}