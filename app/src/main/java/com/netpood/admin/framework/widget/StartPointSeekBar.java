...
public class StartPointSeekBar extends View {
    ...
    private static final int DEFAULT_RANGE_COLOR = Color.parseColor("#747474");
    private static final int DEFAULT_BACKGROUND_COLOR = Color.parseColor("#d5d5d5");
    ...
    public StartPointSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (thumbImagePressedDrawable == null) {
            thumbImagePressedDrawable = getResources().getDrawable(R.drawable.seek_thumb_normal);
        }
