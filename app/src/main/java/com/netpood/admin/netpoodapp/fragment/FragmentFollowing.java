...
import com.netpood.admin.netpoodapp.adapter.AdapterFollowingltem;
...
public class FragmentFollowing extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    view = inflater.inflate(R.layout.fargment_following, container, false);

    //final EditText edtSearch = (EditText) view.findViewById(R.id.edt_search);
    //edtSearch.setTypeface(Base.font1);

    RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.recycler_view);
    AdapterFollowingltem newsAdapter = new AdapterFollowingltem(Base.getCurrentActivity(), DataFakeFollow.getData(Base.getCurrentActivity()));
