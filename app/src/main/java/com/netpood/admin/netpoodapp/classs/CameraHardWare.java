package com.netpood.admin.netpoodapp.classs;
...
public class CameraHardWare {
   ...
   */
  private CameraHardWare(Builder builder) {
    ...
    authority = "com.netpood.admin.netpoodapp.fileprovider";
  }
  ...
  /**
   * CameraHardWare builder declaration
   */
  public static class Builder {
    ...
    public Builder() {
      dirName = CameraHardWare.IMAGE_DEFAULT_DIR;
      imageName = CameraHardWare.IMAGE_DEFAULT_NAME + System.currentTimeMillis();
      imageHeight = CameraHardWare.IMAGE_HEIGHT;
      compression = CameraHardWare.IMAGE_COMPRESSION;
      imageType = CameraHardWare.IMAGE_FORMAT_JPG;
      REQUEST_TAKE_PHOTO = CameraHardWare.REQUEST_TAKE_PHOTO;
    }
    ...
    public CameraHardWare build(Activity activity) {
      this.activity = activity;
      context = activity.getApplicationContext();
      mode = MODE.ACTIVITY;
      return new CameraHardWare(this);
    }

    public CameraHardWare build(Fragment fragment) {
    ...
    public CameraHardWare build(android.support.v4.app.Fragment fragment) {
